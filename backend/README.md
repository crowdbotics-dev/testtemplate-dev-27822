...
## Project Structure
    ...
    ├── testtemplate_dev_27822  # Django project configurations
...
1. Clone this repo and `cd testtemplate_dev_27822`
...
2. Clone this repo and `cd testtemplate_dev_27822`
